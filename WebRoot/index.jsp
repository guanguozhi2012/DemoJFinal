...
<title>首页</title>
<link rel="stylesheet" type="text/css" href="jquery-easyui-1.3.3/themes/metro-blue/easyui.css">
<link rel="stylesheet" type="text/css" href="jquery-easyui-1.3.3/themes/icon.css">
<link rel="stylesheet" type="text/css" href="jquery-easyui-1.3.3/portal.css">
<style type="text/css">
	.title{
		font-size:16px;
		font-weight:bold;
...
<script type="text/javascript" src="jquery-easyui-1.3.3/jquery.portal.js"></script>
...
<body class="easyui-layout">
	<div region="north" class="title" border="false" style="height:60px;">
		Jquery Protal插件
		<fmt:formatNumber pattern="0.00" value="4455.3555121"></fmt:formatNumber>
		<jsp:useBean id="current" class="java.util.Date" scope="page"/>
	</div>
